...
// df_api.plug.so, df_api.plug.dylib, or df_api.plug.dll in this case
DFHACK_PLUGIN("df_api");
...
command_result df_api (color_ostream &out, std::vector <std::string> & parameters);
...
DFhackCExport command_result plugin_init (color_ostream &out, std::vector <PluginCommand> &commands)
{
    ...
    commands.push_back(PluginCommand(
        "df_api", "Do nothing, look pretty.",
        df_api, false, /* true means that the command can't be used from non-interactive user interface */
